...
type TripServiceClient interface {
	...
	UpdateTripStatus(ctx context.Context, in *UpdateTripStatusRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *tripServiceClient) UpdateTripStatus(ctx context.Context, in *UpdateTripStatusRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TripServiceServer interface {
	...
	UpdateTripStatus(context.Context, *UpdateTripStatusRequest) (*emptypb.Empty, error)
...
func (UnimplementedTripServiceServer) UpdateTripStatus(context.Context, *UpdateTripStatusRequest) (*emptypb.Empty, error) {
